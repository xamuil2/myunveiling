...
export function MusicPlayer({ albumTitle, artist, coverArt }: MusicPlayerProps) {
  ...
  return (
    <Card className="fixed bottom-0 left-0 right-0 p-4 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 music-player-bar z-50">
